...
class ShareOTPController extends ApiController {
	 ...
	 *
	 * @return JSONResponse<Http::STATUS_CREATED, Files_SharingOTPSendSuccess, array{}>|JSONResponse<Http::STATUS_FORBIDDEN|Http::STATUS_NOT_FOUND, list<empty>, array{}>|JSONResponse<Http::STATUS_INTERNAL_SERVER_ERROR, Files_SharingOTPSendError, array{}>
	 *
