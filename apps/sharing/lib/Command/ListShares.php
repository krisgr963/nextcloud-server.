...
final class ListShares extends SharingBase {
	...
	public function execute(InputInterface $input, OutputInterface $output): int {
		...
		try {
			$output->writeln(json_encode(array_map(fn (Share $share): array => $share->format($this->registry, $this->l10nFactory, $this->urlGenerator, $this->userManager), $this->manager->listShares($this->accessContext, $filterSourceTypeClass, $filterSourceTypeValue, $lastShareID, $limit)), JSON_THROW_ON_ERROR));
			return Base::SUCCESS;
