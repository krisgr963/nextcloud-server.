import{c as u}from"./index-CbuK25qB.chunk.mjs";import{g as y,f as c,c as f}from"./index-DgEyzq8A.chunk.mjs";import{t as o}from"./translation-DoG5ZELJ-BfTm5Q53.chunk.mjs";import{c as h}from"./index-BdVR7dh0.chunk.mjs";import{g as b}from"./dav-hk-joNZf.chunk.mjs";const r=y().setApp("systemtags").detectUser().build(),O={userVisible:!0,userAssignable:!0,canAssign:!0},x=Object.freeze({"display-name":"displayName","user-visible":"userVisible","user-assignable":"userAssignable","can-assign":"canAssign"});function p(t){return t.map(({props:s})=>Object.fromEntries(Object.entries(s).map(([e,a])=>(e=x[e]??e,a=e==="displayName"?String(a):a,[e,a]))))}function w(t){const s=t.indexOf("?");s>0&&(t=t.substring(0,s));const e=t.split("/");let a;do a=e[e.length-1],e.pop();while(!a&&e.length>0);return Number(a)}function v(t){if("name"in t&&!("displayName"in t))return{...t};const s={...t};return s.name=s.displayName,delete s.displayName,s}function V(t){const s=t.attributes?.["system-tags"]?.["system-tag"];return s===void 0?[]:[s].flat().map(e=>typeof e=="string"?e:e.text)}function N(t,s){t.attributes["system-tags"]={"system-tag":s},c("files:node:updated",t)}const n=b(),l=`<?xml version="1.0"?>
...
//# sourceMappingURL=api-62CBZWnN.chunk.mjs.map
